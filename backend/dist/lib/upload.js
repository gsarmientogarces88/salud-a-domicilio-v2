...
exports.receiptUpload = exports.resultUpload = exports.orderUpload = void 0;
exports.publicUploadPath = publicUploadPath;
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
const multer_1 = __importDefault(require("multer"));
const root = path_1.default.join(process.cwd(), 'uploads', 'lab');
const receiptsRoot = path_1.default.join(process.cwd(), 'uploads', 'receipts');
['orders', 'results'].forEach((d) => {
    const p = path_1.default.join(root, d);
    if (!fs_1.default.existsSync(p))
        fs_1.default.mkdirSync(p, { recursive: true });
});
if (!fs_1.default.existsSync(receiptsRoot))
    fs_1.default.mkdirSync(receiptsRoot, { recursive: true });
